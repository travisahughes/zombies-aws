        ...
        <div id="faq" className="common-padding" css={faq}>
            ...
            <div id="faq-list">
                ...
                <FaqItem 
                    ...
                    content={
                        <ul>
                            <li>Value & Strategy - We are DEAD set on delivering value for our holders. We’ll be introducing mechanics for “staking” and eventually burning. New generations of zombies will help to grow our community while genesis (Gen 1) holders will benefit from the overall growth of the project. Every decision we make will be keeping the value of the project and NFTs in mind. We are huge fans of NFTs and will use our favorite projects for inspiration while adding our own crazy twists to give a fresh experience.</li>
                            <li>The Team – We are a mix of individuals with expertise in the areas we work in and we are NFT fanatics. With backgrounds at ESPN, Disney, FuboTV, Apple, Spotify and more – we value the importance of brand and fans and are excited to be in the NFT space and grow this project.</li>
                            <li>Nice Fun Zombie Universe – We are building a zombie universe both in our community and tied to the NFTs. Storytelling is at the heart of what we believe in and we’re building something fun long-term. In the meantime, fans can help us get to the moon by join the community and share their fandom for all things zombie!</li>
                            <li>Brand Focus - There is a long term vision of working more closely with brands, helping them navigate the NFT space in an authentic way, and showing them the power of community. We'll start with goals to work with zombie specific projects (movies, shows, video games, etc.), which will establish ourselves before we expand further!</li>
                        </ul>
                    }
                />
                <FaqItem 
