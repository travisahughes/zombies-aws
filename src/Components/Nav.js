    ...
    return (
        <header css={header}>
            <div id="top" className="header-left">
                <div id="hamburger" onClick={toggleMenu}><img src={burger} alt="menu" /></div>
                <div id="logo"><a href="/">Nice Fun <span className="green-highlight">Zombies</span></a></div>
            </div>
            <div className={`header-right toggle-${toggleState}`}>
                <ul css={navmenu}>
                    ...
                    <li className="icon" id="discord"><a href="https://discord.gg/77VswFkcuY" target="_blank" rel="noreferrer"onClick={toggleMenu}><img alt="discord" src={discordLogo} /></a></li>
